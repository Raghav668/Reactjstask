...
componentDidMount(){
    ...
    this.firstnameref.current.style.backgroundColor = "blue"
    this.firstnameref.current.style.color = "red"
}
    ...
    render() {
        return (
            ...
            <form onSubmit={(e)=>{this.aftersubmitted(e)}} className={style.form}>
                ...
                <input type= "text" name='firstname' className={style.input} onChange={(e)=>{this.afterchanged(e)}} ref={this.firstnameref}value={this.state.firstname} onFocus={()=>{this.onfocus()}}/>
