...
function Moviesearch() {
    ...
    const aftersearched = async () =>{
        const response = await fetch(`http://www.omdbapi.com/?s=${food}&apikey=9bf543be`)
  ...
  return (
        <div>
            ...
            <form onSubmit={searchit}>   
                ...
                <input type="text" onChange={(e)=>{setFood(e.target.value)}}  value={food}/><br/><br/>
